...
MainFrame::MainFrame(const wxString& title) : wxFrame(nullptr, wxID_ANY, title)
{
	...
	staticText->SetBackgroundColour(*wxCYAN);
	...
	wxGauge* gauge = new wxGauge(panel, wxID_ANY, 50, wxPoint(590, 205), wxSize(-1,125), wxGA_VERTICAL);
	...
	wxSpinCtrl* spinCtrl = new wxSpinCtrl(panel, wxID_ANY, "Enter Title ", wxPoint(550, 375), wxSize(100, -1), wxSP_WRAP); // uses the <wx/spinctrl.h> include
	...
	wxRadioBox* radioBox = new wxRadioBox(panel, wxID_ANY, "Enter Title", wxPoint(555,450), wxDefaultSize, choices, 1);
}
